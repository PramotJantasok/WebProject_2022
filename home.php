...
<!-- navbar-expand -->
  <nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
      <!-- <a class="navbar-brand" href="#">Book'n Stationery SHOP</a> -->
      <div class="col-md-4 col-sm-6 col-lg-6 col-xl-6 col-xxl-7 col-4 n_link">
        ...
        <div class="col-8 col-md-8 col-sm-6 col-lg-6 col-xl-6 col-xxl-5 d-flex justify-content-end ">
          <form class="d-flex col-8 col-md-6 col-sm-10 col-lg-8 col-xl-8 col-xxl-8" role="search">
          ...
          <button class="btn btn-primary" id="show" onclick="popup()"><i class="bi bi-person-circle"></i></button>
        </div>
        <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="password" class="form-control" placeholder="" aria-label="Password"
                                            id="regis_pass" name="PasswordRegister">
                                        <button class="input-group-text" type="button" id="see" onclick="seePassword()"
                                            value="0">
