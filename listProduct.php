...
function setList($Group){
    ...
    foreach ($data as $getBooks){
        if ($getBooks->group == $Group ){
            ...
            echo '<div class="add-to-cart-button"><a href="product.php?book='.$indexNumber.'" data-quantity="1" class="primary is-small mb-0 button product_type_simple add_to_cart_button ajax_add_to_cart is-outline" rel="nofollow">รายละเอียดสินค้า</a></div>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
        }
